<footer <?php $webpage->disableFooter() ?>>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="../pages/about.php" class="nav-link p-0 text-body-secondary">About</a></li>
                            <li class="nav-item mb-2"><a href="../pages/animal.php" class="nav-link p-0 text-body-secondary">Animal</a></li>
                            <li class="nav-item mb-2"><a href="../pages/hotel.php" class="nav-link p-0 text-body-secondary">Hotel</a></li>
                            <li class="nav-item mb-2"><a href="../pages/ticket.php" class="nav-link p-0 text-body-secondary">Ticket</a></li>
                        </ul>
                    </div>
                    <div class="col-6">
                        <h5>Other</h5>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center py-3 mb-3 border-top" data-bs-theme="dark">
        ...
        <button class="btn btn-primary btn-circle justify-content-end me-2 fs-5" title="Back to top" onclick="scrollToTop()">^</button>
    </div>
</footer>
